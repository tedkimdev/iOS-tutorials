//
//  PreferencesTableTableViewController.swift
...
class PreferencesTableTableViewController: UITableViewController {
    ...
    func savePreferences() -> Preferences {
    ...
    func preferencesFromTableData() -> Preferences {
        print("preferencesFromTableData is called.")
